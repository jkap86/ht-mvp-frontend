...
class PublicLeaguesScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PublicLeaguesScreen> createState() => _PublicLeaguesScreenState();
}

class _PublicLeaguesScreenState extends ConsumerState<PublicLeaguesScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Widget _buildBody(PublicLeaguesState state) {
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: _buildJoinButton(context, colorScheme),
            ),
          ],
        ),
      ),
